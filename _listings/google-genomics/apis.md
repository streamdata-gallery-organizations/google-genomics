...
- name: Google Genomics API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-genomics/master/_listings/google-genomics/v1-resource-testiampermissions-post.md
x-common:
